...
},beforePageText:"第",afterPageText:"页，公of {pages}",displayMsg:"在{total}条记录中显示{from}到{to}条",nav:{first:{iconCls:"pagination-first",handler:function(){
